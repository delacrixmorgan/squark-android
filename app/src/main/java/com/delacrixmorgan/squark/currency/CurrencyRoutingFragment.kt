...
class CurrencyRoutingFragment : Fragment() {
    companion object {
        ...
        ): CurrencyRoutingFragment {
            val fragment = CurrencyRoutingFragment()
            val args = Bundle()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val fragment = when {
            this.baseCurrencyCode != null -> CurrencyListFragment.newInstance(baseCurrencyCode = this.baseCurrencyCode)
            this.quoteCurrencyCode != null -> CurrencyListFragment.newInstance(quoteCurrencyCode = this.quoteCurrencyCode)
