...
import com.delacrixmorgan.squark.databinding.FragmentWallpaperPreviewBinding
...
class WallpaperPreviewFragment : Fragment(), RowListener {
    companion object {
        fun create() = WallpaperPreviewFragment()
    }
