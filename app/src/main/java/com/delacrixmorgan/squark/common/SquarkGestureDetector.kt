...
/**
 * SquarkGestureDetector
 * squark-android
 *
 * Created by Delacrix Morgan on 11/07/2018.
 * Copyright (c) 2018 licensed under a Creative Commons Attribution-ShareAlike 4.0 International License.
 */

class SquarkGestureDetector(private val context: Context, private val listener: SwipeGesture) : GestureDetector.OnGestureListener {
